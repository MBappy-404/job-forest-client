                    ...
                    <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                         ...
                         <div className='text-center'>
                              <div
                                   ...
                                   <ul className="items-center bg-none  rounded-lg  font-medium text-lg  lg:bg-none p-10 md:p-0 justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                                        ...
                                        <li className="text-white cursor-pointer hover:text-indigo-200">{user?.uid ? <span onClick={handleLogOut}>Log Out</span> : <span><Link to='/signIn'>Sign In</Link></span>}</li>
