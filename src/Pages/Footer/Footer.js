...
const Footer = () => {
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
        Consectetur adipisicing elit sed do eiusmod tempor incididunt enimadiume minim veniam quis nostrud exercitation ullamco labois niisie ut www.jobforest.com 
        </p>
      </div>
      <div class="">
  ...
  <div class="text-center p-6 bg-gray-200">
    ...
    <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Muhammad Bappy</a>
  </div>
</footer>
          </div>
     );
